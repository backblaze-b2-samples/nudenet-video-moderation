...
@pytest.mark.asyncio
async def test_moderation_job_rejects_non_video(client):
    """A non-video upload is rejected with 415 before any pipeline work."""
...
@pytest.mark.asyncio
async def test_moderation_job_rejects_empty_video(client):
    """An empty video is rejected with 400."""
    from io import BytesIO
