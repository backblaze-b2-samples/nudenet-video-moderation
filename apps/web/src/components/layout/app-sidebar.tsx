...
const navItems = [
  ...
  { title: "New Scan", href: "/jobs/new", icon: ShieldCheck },
  { title: "Review Queue", href: "/jobs", icon: ListChecks },
  ...
  return (
    <Sidebar>
      ...
      <SidebarFooter className="border-t border-sidebar-border px-4 py-3">
        <a
          href="https://www.backblaze.com/cloud-storage?utm_source=github&utm_medium=referral&utm_campaign=ai_artifacts&utm_content=nudenet-video-moderation"
          target="_blank"
